...
function Hero() {
  return (
    <section
      id="home"
      className="min-h-screen bg-transparent text-white pt-24 flex items-center"
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-12">

        {/* Glass Container */}
        <div className="grid lg:grid-cols-2 gap-20 items-center bg-slate-900/20 backdrop-blur-sm rounded-3xl p-8 lg:p-12">
  ...
  Transforming ideas into intelligent digital solutions through Full Stack
  Development, Artificial Intelligence, Machine Learning, and IoT. I am
  committed to building high-quality applications that deliver meaningful
  user experiences and real-world impact.
            ...
            <div className="flex flex-wrap gap-5 mt-10">
              ...
              <a
                href="#projects"
                className="px-8 py-3 rounded-xl bg-gradient-to-r from-blue-600 to-cyan-500 hover:scale-105 transition duration-300"
              >
                View Projects
              </a>
            ...
            <div className="flex gap-4 mt-8">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="px-5 py-3 rounded-lg bg-slate-800/80 hover:bg-blue-600 transition"
              >
                GitHub
              </a>
